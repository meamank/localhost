...
// The upstream CJS build has a broken default-import interop with @expo/config-plugins.
// This is a corrected version of the plugin that works with Expo SDK 56.
  ...
  if (forceCxx20) {
    ...
    config = withDangerousMod(config, [
      ...
      async (c) => {
        ...
        const postInstallIdx = contents.indexOf(
